...
\epsilon \sim N(0, \sigma^2)
$$
These equations show us that the contribution of an observed shot (in game $g_i$) to the likelihood of the current shot (in game $g_0$) decreases as the distance between the observations increases, and as $\Delta$ decreases. The code for each otf these models is 
