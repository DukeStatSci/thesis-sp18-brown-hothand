...
In this model, $X$ refers to the data, $\beta$ is the estimated pareter from the model, and $\epsilon$ is random error. The subscripts $\textit{int}$, $\textit{r}$, $\theta$, and $\textit{H}$ respectively refer to the intercept, the log-distance of the shot, the angle of the shot, and whether shot was taken on Duke's home court or another gym.
