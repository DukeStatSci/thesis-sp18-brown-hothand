...
# TODO:
  # how do you do the figure labeling without hard-coding?
...
discplot1 <- plot_time_effect(game.params.750, id=id1, parameter=c("intH", "intA"), main=expression(paste("Player 1 Intercepts, ", Delta, " = 0.750")))
discplot2 <- plot_time_effect(game.params.750, id=id2, parameters=c("intH", "intA"), main=expression(paste("Player 2 Intercepts, ", Delta, " = 0.750")))
discplot3 <- plot_time_effect(game.params.750, id=id3, parameters=c("intH", "intA"), main=expression(paste("Player 3 Intercepts, ", Delta, " = 0.750")))
discplot4 <- plot_time_effect(game.params.750, id=id4, parameters=c("intH", "intA"), main=expression(paste("Player 4 Intercepts, ", Delta, " = 0.750")))
discplot5 <- plot_time_effect(game.params.750, id=0, parameters=c("intH", "intA"), main=expression(paste("Team Intercepts, ", Delta, " = 0.750")))

grid.arrange(discplot1,discplot2,discplot3,discplot4, nrow=2)
discplot5

discplot6 <- plot_time_effect(game.params.999, id=id1, parameter=c("intH", "intA"), main= expression(paste("Player 1 Intercepts, ", Delta, " = 0.999")))
discplot7 <- plot_time_effect(game.params.999, id=id2, parameters=c("intH", "intA"), main=expression(paste("Player 2 Intercepts, ", Delta, " = 0.999")))
discplot8 <- plot_time_effect(game.params.999, id=id3, parameters=c("intH", "intA"), main=expression(paste("Player 3 Intercepts, ", Delta, " = 0.999")))
discplot9 <- plot_time_effect(game.params.999, id=id4, parameters=c("intH", "intA"), main=expression(paste("Player 4 Intercepts, ", Delta, " = 0.999")))
discplot10 <- plot_time_effect(game.params.999, id=0, parameters=c("intH", "intA"), main=expression(paste("Team Intercepts, ", Delta, " = 0.999")))
