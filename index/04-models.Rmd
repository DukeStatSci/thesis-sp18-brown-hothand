...
p <- c("intH", "intA")
z <- c("Intercept (Away)", "Intercept (Home)")
# discplot1A <- plot_time_effect(game.params.750, id=id1, parameters=p, main="Player 1", zlab = z)
# discplot2A <- plot_time_effect(game.params.750, id=id2, parameters=p, main="Player 2", zlab = z)
# discplot3A <- plot_time_effect(game.params.750, id=id3, parameters=p, main="Player 3", zlab = z)
# discplot4A <- plot_time_effect(game.params.750, id=id4, parameters=p, main="Player 4", zlab = z)
discplot5A <- plot_time_effect(game.params.750, id=0, parameters=p, main="Team Effect", zlab = z)

# discplot1B <- plot_time_effect(game.params.999, id=id1, parameters=p, main="Player 1", zlab = z)
# discplot2B <- plot_time_effect(game.params.999, id=id2, parameters=p, main="Player 2", zlab = z)
# discplot3B <- plot_time_effect(game.params.999, id=id3, parameters=p, main="Player 3", zlab = z)
# discplot4B <- plot_time_effect(game.params.999, id=id4, parameters=p, main="Player 4", zlab = z)
discplot5B <- plot_time_effect(game.params.999, id=0, parameters=c(p[2],p[1]), main="Team Effect", zlab = c(z[2],z[1]))
