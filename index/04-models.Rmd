...
plot_time_effect <- function(game.params = NA, id = NA, parameters = NA, main=NA, zlab=NA, only_fga_games = TRUE){
  ...
  plotdat <- game.params %>% 
    ...
    geom_line(size=1.5) +   
    theme_bw() +
    labs(title=main, y="Estimate", x="Game", color = "Parameters", z=zlab) + 
    theme(panel.grid = element_blank())
