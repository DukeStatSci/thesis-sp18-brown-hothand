...
This book contains information about discounted likelihood regression, or **EVP or some acronym like that**, in Chapter **chapter**. Although the material in this book focues on data with a Normal response instead of a Binomial, we use this information to help explain the concepts behind our discounted likelihood models in Section **number.number.number**.
