...
To illustrate results from the discounted likelihood model with $\Delta$ = 0.850, we plot the location parameters over time for a high-usage player, a low-usage player, and the overall team. We also try some variances. **make this sound more academic**
...
We can see that the parameters move over time. **elaborate**
