...
plot_time_effect(game.params.850, id=0, parameters=c("intH","intA", "r", "theta"), main="Team", zlab=c("Intercept (Home)", "Intercept (Away)", "Distance", "Angle"))
```


We can see that the parameters move over time. **elaborate. like the team parameters move the most over time.**
