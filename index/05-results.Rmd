...
#TODO: delete these once multi processing is complete
   eval(parse(
     text=paste0("game.mcmc.list.",deltas_str," <- load_gamelist(",deltas_str,", get_rdatafiles(k0));\n")
   ))
