...
if(!load_chains){
  ...
  load(file="../rdatafiles/gamemcmclist100.RData")
  load(file="../rdatafiles/gamemcmclist250.RData")
  load(file="../rdatafiles/gamemcmclist375.RData")
  load(file="../rdatafiles/gamemcmclist500.RData")
  load(file="../rdatafiles/gamemcmclist625.RData")
  load(file="../rdatafiles/gamemcmclist750.RData")
  load(file="../rdatafiles/gamemcmclist850.RData")
  load(file="../rdatafiles/gamemcmclist900.RData")
  ...
  load(file="../rdatafiles/paramsseason100.RData")
  load(file="../rdatafiles/paramsseason250.RData")
  load(file="../rdatafiles/paramsseason375.RData")
  load(file="../rdatafiles/paramsseason500.RData")
  load(file="../rdatafiles/paramsseason625.RData")
  load(file="../rdatafiles/paramsseason750.RData")
  load(file="../rdatafiles/paramsseason850.RData")
  load(file="../rdatafiles/paramsseason900.RData")
