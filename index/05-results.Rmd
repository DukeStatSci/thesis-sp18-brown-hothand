...
fourparams <- merge(playerseasons, params.player ,all=FALSE) %>% select(globalplayerid, int, r, theta)
...
plot_contours <- function(probsxy = NA, main=""){
  ...
  img.path <- "/home/grad/neb20/hothand/index/figure/ncaa_bball_court2.png"
