...
=======
>>>>>>> parent of 35e6867... predictions and fitted values
...
glmplot1 <- plot_params(glm1)
glmplot2 <- plot_params(glm2)
glmplot3 <- plot_params(glm3)
glmplot4 <- plot_params(glm4)
glmplot5 <- plot_params(glmtot)
...
classrates <- c(eval.team.p[[1]]$classificationrate, 
                eval.player.p[[1]]$classificationrate
                )

logliks <- c(eval.team.f[[1]]$loglik, 
             eval.player.f[[1]]$loglik
             )

mses <- c(eval.team.p[[1]]$mse, 
          eval.player.p[[1]]$mse
          )

df_delta <- data.frame(d = deltas, classrates_delta, logliks_delta, mses_delta)
types <- c("GLM", "Mixed Effects")
df <- data.frame(type=factor(types, levels=types), classrates, logliks, mses)
...
g3 <- ggplot(data=df_delta, aes(x=d,y=mses_delta)) +
  ...
  theme_bw() + 
  labs(y="MSE", x="delta", linetype = "")

grid.arrange(g1, g2, g3, nrow=2)

# df_fitvals <- data.frame(
#   d750 = fitted.game.750,
#   d800 = fitted.game.800,
#   d850 = fitted.game.850,
#   d900 = fitted.game.900,
#   d950 = fitted.game.950,
#   d999 = fitted.game.999
# ) %>% melt(id=NULL)
# 
# ggplot(df_fitvals, aes(x=value, col=variable)) + geom_density(size=1)
```
