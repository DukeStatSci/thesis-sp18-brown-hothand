...
n.chains = n.chains, : Unused variable "tau0r" in data
\end{verbatim}
\begin{verbatim}
Warning in jags.model(model.file, data = data, inits = init.values,
n.chains = n.chains, : Unused variable "tau0theta" in data
\end{verbatim}
\begin{verbatim}
...
\end{Highlighting}
\end{Shaded}
\includegraphics{thesis_files/figure-latex/hier-1.pdf}
\begin{Shaded}
\begin{Highlighting}[]
...
\end{Highlighting}
\end{Shaded}
\includegraphics{thesis_files/figure-latex/hier-2.pdf}
\begin{Shaded}
\begin{Highlighting}[]
...
\end{Highlighting}
\end{Shaded}
\includegraphics{thesis_files/figure-latex/hier-3.pdf}
...
\NormalTok{fit_dglm <-}\StringTok{ }\NormalTok{function(playerids, seasons, }\DataTypeTok{iterate=}\OtherTok{TRUE}\NormalTok{)\{}
  ...
  \CommentTok{# pscore <- fitted(mod, type="response") #GLM predictions}
  \CommentTok{# q <- rep(NaN, T)}
  \CommentTok{# q[shots] <- pscore #q is just the GLM prediction}

  \CommentTok{# par(xpd=TRUE)}
  \CommentTok{# plot(0,0,type="n",xlim = c(0,T),ylim=c(0,1), ylab = "probability", xlab = "time index", main = "GLM Predictions")}
  \CommentTok{# points(tshot, q[tshot], pch=4, col = "blue")}
  ...
  \CommentTok{# par(xpd=FALSE)}
  \CommentTok{# plot(X[iy,c("x","y")], ylim=c(0,ym), xlim=c(-xm/2,xm/2), col = "red", pch = 3, xlab="x", ylab="y", main = "Makes and Misses")}
  \CommentTok{# points(X[-iy,c("x","y")], col ="blue", pch = 1)}
  \CommentTok{# abline(h=ym/2)}
  \CommentTok{# points(0,0,col="red", cex=2)}
  ...
  \NormalTok{for(t in }\DecValTok{1}\NormalTok{:T)\{}
    \NormalTok{if(t %in%}\StringTok{ }\NormalTok{tshot)\{}
      ...
      \CommentTok{#            "Z[i,]=",F[,ishot],"\textbackslash{}t",}
      \CommentTok{#            "mt=",mt,"\textbackslash{}n"))}
      \CommentTok{# }
      \CommentTok{#  if(rt > 1000)\{}
      \CommentTok{#    break}
      \CommentTok{#  \}}
...
\StringTok{                  }\KeywordTok{lgamma}\NormalTok{(}\DecValTok{2}\NormalTok{) -}\StringTok{ }\KeywordTok{lgamma}\NormalTok{(}\DecValTok{1}\NormalTok{+y[t]) -}\StringTok{ }\KeywordTok{lgamma}\NormalTok{(}\DecValTok{2}\NormalTok{-y[t])}
      ...
      \NormalTok{mt <-}\StringTok{ }\NormalTok{mt+At%*%(fts-ft)}
...
\NormalTok{plot_dynamics <-}\StringTok{ }\NormalTok{function(smt)\{}
  ...
  \KeywordTok{plot}\NormalTok{(smt[}\DecValTok{1}\NormalTok{,],}\DataTypeTok{type=}\StringTok{"l"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"blue"}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"shot index"}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"online state mean"}\NormalTok{, }\DataTypeTok{main =} \StringTok{"Dynamic Parameters"}\NormalTok{)}
  ...
  \KeywordTok{legend}\NormalTok{(}\DataTypeTok{x=}\NormalTok{T*.}\DecValTok{75}\NormalTok{, }\DataTypeTok{y=}\DecValTok{4}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{c}\NormalTok{(}\StringTok{"intercept"}\NormalTok{, }\StringTok{"angle"}\NormalTok{, }\StringTok{"log(distance)"}\NormalTok{), }\DataTypeTok{pch =} \KeywordTok{c}\NormalTok{(}\DecValTok{16}\NormalTok{), }\DataTypeTok{col =} \KeywordTok{c}\NormalTok{(}\StringTok{"blue"}\NormalTok{, }\StringTok{"orange"}\NormalTok{, }\StringTok{"yellow"}\NormalTok{))}
...
\end{Highlighting}
\end{Shaded}
\includegraphics{thesis_files/figure-latex/dglm-1.pdf}
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot_posteriors}\NormalTok{(dglm1[[}\DecValTok{4}\NormalTok{]])}
\end{Highlighting}
\end{Shaded}
\includegraphics{thesis_files/figure-latex/dglm-2.pdf}
\includegraphics{thesis_files/figure-latex/dglm-3.pdf}
\includegraphics{thesis_files/figure-latex/dglm-4.pdf}
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot_dynamics}\NormalTok{(dglm2[[}\DecValTok{1}\NormalTok{]])}
\end{Highlighting}
\end{Shaded}
\includegraphics{thesis_files/figure-latex/dglm-5.pdf}
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot_posteriors}\NormalTok{(dglm2[[}\DecValTok{4}\NormalTok{]])}
\end{Highlighting}
\end{Shaded}
\includegraphics{thesis_files/figure-latex/dglm-6.pdf}
\includegraphics{thesis_files/figure-latex/dglm-7.pdf}
\includegraphics{thesis_files/figure-latex/dglm-8.pdf}
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot_dynamics}\NormalTok{(dglm3[[}\DecValTok{1}\NormalTok{]])}
\end{Highlighting}
\end{Shaded}
\includegraphics{thesis_files/figure-latex/dglm-9.pdf}
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot_posteriors}\NormalTok{(dglm3[[}\DecValTok{4}\NormalTok{]])}
\end{Highlighting}
\end{Shaded}
\includegraphics{thesis_files/figure-latex/dglm-10.pdf}
\includegraphics{thesis_files/figure-latex/dglm-11.pdf}
\includegraphics{thesis_files/figure-latex/dglm-12.pdf}
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot_dynamics}\NormalTok{(dglm4[[}\DecValTok{1}\NormalTok{]])}
\end{Highlighting}
\end{Shaded}
\includegraphics{thesis_files/figure-latex/dglm-13.pdf}
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot_posteriors}\NormalTok{(dglm4[[}\DecValTok{4}\NormalTok{]])}
\end{Highlighting}
\end{Shaded}
\includegraphics{thesis_files/figure-latex/dglm-14.pdf}
\includegraphics{thesis_files/figure-latex/dglm-15.pdf}
\includegraphics{thesis_files/figure-latex/dglm-16.pdf}
